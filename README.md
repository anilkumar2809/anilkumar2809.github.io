...
A modern, minimalist portfolio template built with Astro and Tailwind CSS. This portfolio is customized to showcase my skills, experience, and projects in a clean, professional way.
This is based on the template (https://github.com/RyanFitzgerald/devportfolio) by Ryan Fitzgerald.

## Preview

To view a live preview of the site, [click here](https://anilkumar2809.github.io/).
...
```
git clone https://github.com/anilkumar2809/anilkumar2809.github.io.git
cd devportfolio
npm install
```
